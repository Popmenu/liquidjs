/*
 * liquidjs@8.4.0, https://github.com/harttle/liquidjs
 * (c) 2016-2019 harttle
...
function dangerouslyStringify(value) {
    if (isNil(value))
        return '';
...
var Render = /** @class */ (function () {
    ...
    Render.prototype.renderTemplates = function (templates, ctx) {
        return __awaiter(this, void 0, void 0, function () {
            var html, _i, templates_1, tpl, output, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 4:
                        ...
                        if (e_1.name === 'RenderBreakError') {
                            e_1.resolvedHTML = String(html.map(function (h) { return stringify(h); }).join(''));
                            throw e_1;
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        val = _a.sent();
                        return [2 /*return*/, dangerouslyStringify(toValue(val))];
                }
            });
        });
    };
