...
export default class Liquid {
    ...
    render(tpl: ITemplate[], ctx?: object, opts?: LiquidOptions): Promise<any[]>;
    parseAndRender(html: string, ctx?: object, opts?: LiquidOptions): Promise<any[]>;
    ...
    express(): (this: any, filePath: string, ctx: object, cb: (err: Error | null, html?: any[] | undefined) => void) => void;
